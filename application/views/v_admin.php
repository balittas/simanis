...
<html lang="en" id="home">
  ...
  <body>
    ...
    <div class="sidenav" style="padding-top: 10px;">        
        <a href="#tabelSerat"><i class="glyphicon glyphicon-chevron-right"></i> Data Pemanis  </a>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" style="font-size: 18px;">Tambah Data Pemanis</h4>
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          </div>
          <form enctype="multipart/form-data" action="<?php echo site_url('/admin/tambahSerat'); ?>" method="post" class="form-horizontal" autocomplete="off">
            <div class="modal-body">
              <div class="form-group">
                <label>Nama Pemanis</label>
    ...
    <div id="tomboleditserat" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" style="font-size: 18px;">Edit Data Pemanis</h4>`
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          </div>
          <form enctype="multipart/form-data" action="<?php echo site_url('/admin/editSerat'); ?>" method="post" class="form-horizontal" autocomplete="off">
            <div class="modal-body">
    ...
    <div id="hapusserat" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          <form>
            <div class="modal-header">            
              <h4 class="modal-title" style="font-size: 18px;">Hapus Data Pemanis</h4>
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body">          
            ...
            <div class="row">
              ...
              <div class="col-sm-2" style="padding-top: 0px;">
                <select class="form-control komoditas" id="jenisKomoditas" name="komoditas" style="margin-left: -77px; width: 170px; height: 35px;" onchange="filterVarietas();">
                  ...
                  <?php
                    $komoditas = array("Semua Komoditas","Tebu","Stevia","Gula Bit");
    ...
    <div id="tomboleditvar" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form enctype="multipart/form-data" action="<?php echo site_url('admin/editVarietas'); ?>" method="post" class="form-horizontal" autocomplete="off">
            <div class="modal-body">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="idjenisKomoditas">
                  <option value="S0012">Tebu</option>
                  <option value="S0013">Stevia</option>
                  <option value="S0014">Gula Bit</option>
                </select>    
              </div>
              <div class="form-group">
                <label>Tanggal Pelepasan</label>       
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="color: white;">&times;</button>
                 ...
                 <form enctype="multipart/form-data" action="<?php echo site_url('admin/tambahLeaflet');?>" method="post" class="form-horizontal" autocomplete="off">
                    <div class="modal-body">
                        <div class="form-group">
    ...
    <div id="tomboleditleaflet" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form enctype="multipart/form-data" action="<?php echo site_url('admin/editLeaflet'); ?>" method="post" class="form-horizontal" autocomplete="off">
            <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-2" style="padding-top: 0px;">
                <select class="form-control komoditasbud" id="jenisKomoditasbud" name="komoditasbud" style="margin-left: -169.5px; width: 170px; height: 35px;" onchange="filterBudidaya();">
                       <option value="Semua Komoditas" selected>Semua Komoditas</option>
                  <?php
                    $komoditasbud = array("Semua Komoditas","Tebu","Stevia","Gula Bit");
    ...
    <div id="tambahbudidaya" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form enctype="multipart/form-data" action="<?php echo site_url('admin/tambahBudidaya'); ?>" method="post" class="form-horizontal" autocomplete="off">
            <div class="modal-body">
              <div class="form-group">
                <label>Komoditas</label>
    ...
    <div id="tomboleditbudidaya" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form enctype="multipart/form-data" action="<?php echo site_url('admin/editBudidayaaaa'); ?>" method="post" class="form-horizontal" autocomplete="off">
            <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-2" style="padding-top: 0px;">
                <select class="form-control komoditasbenihh" id="jenisKomoditasstokfilter" name="komoditasstokfilter" style="margin-left: -169.5px; width: 170px; height: 35px;" onchange="filterStokBenih();">
                       <option value="Semua Komoditas" selected>Semua Komoditas</option>
                  <?php
                    $komoditasbenihh = array("Semua Komoditas","Tebu","Stevia","Gula Bit");
    ...
    <div id="tambahstokbenih" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form enctype="multipart/form-data" action="<?php echo site_url('admin/tambahStokBenihCuy'); ?>" method="post" class="form-horizontal" autocomplete="off">
            <div class="modal-body">
              <div class="form-group">
    ...
    <div id="editstokbenih" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form enctype="multipart/form-data" action="<?php echo site_url('admin/editStokBenih'); ?>" method="post" class="form-horizontal" autocomplete="off">
              <div class="modal-body">
              <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-sm-2" >
                <select class="form-control komoditasdist" id="jenisKomoditasdist" name="komoditasdist" style="margin-left: -105px; width: 170px; height: 35px;" onchange="filterDistribusi();">
                  <option value="Semua Komoditas" selected>Semua Komoditas</option>
                  <?php
                    $komoditasdist = array("Semua Komoditas","Tebu","Stevia","Gula Bit");
    ...
    <div id="editdistribusibenih" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form enctype="multipart/form-data" action="<?php echo site_url('admin/editDistribusiBenih'); ?>" method="post" class="form-horizontal" autocomplete="off">
              <div class="modal-body">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="color: white;">&times;</button>
                 ...
                 <form enctype="multipart/form-data" action="<?php echo site_url('admin/tambahAlsin');?>" method="post" class="form-horizontal">
                    <div class="modal-body">
                        <div class="form-group">
    ...
    <div id="tomboleditalsin" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form enctype="multipart/form-data" action="<?php echo site_url('admin/editAlsin'); ?>" method="post" class="form-horizontal" autocomplete="off">
            <div class="modal-body">
