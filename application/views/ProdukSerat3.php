            ...
            <div class="col-sm-9 col-lg-9">
               ...
               <div class="col-xs-12 col-sm-6 col-lg-6">
                  <div class="thumbnail text-center" style="box-shadow: 5px 5px 7px 0px rgba(0,0,0,0.2);">
                     <img class="leafletImg img-responsive" src="<?php echo base_url() ?>item_img/leafletgabungan/dhislegi.jpeg" alt="" style="width:100%;border-radius: 3px;">
                     <h4 style="color:rgb(242,97,5);">Dhislegi</h4>
                  </div>
               </div>
               <div class="col-xs-12 col-sm-6 col-lg-6">
                  <div class="thumbnail text-center" style="box-shadow: 5px 5px 7px 0px rgba(0,0,0,0.2);">
                     <img class="leafletImg img-responsive" src="<?php echo base_url() ?>item_img/leafletgabungan/gula_merah.jpg" alt="" style="width:100%;border-radius: 3px;">
                     <h4 style="color:rgb(242,97,5);">Gula Merah</h4>
                  </div>
               </div>
